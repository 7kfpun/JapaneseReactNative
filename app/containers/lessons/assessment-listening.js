...
export default class AssessmentMC extends Component<Props> {
  ...
  checkAnswer = (position, correctAnswer, userAnswer) => {
    ...
    if (correctAnswer === userAnswer) {
      ...
      tracker.logEvent('user-assessment-listening-answer-correct', {
        answer: userAnswer,
      ...
      tracker.logEvent('user-assessment-listening-answer-incorrect', {
        answer: userAnswer,
        mode: `${modeFrom} - ${modeTo}`,
      });
    }
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ttsSpeak(question);
            tracker.logEvent('user-assessment-listening-press-read', {
              text: question.kanji,
            });
          }}
        >
        ...
        <View style={styles.selectors}>
          <CustomButton
            ...
            onPress={() => {
              this.getNext();
              tracker.logEvent('user-assessment-listening-press-next');
            }}
