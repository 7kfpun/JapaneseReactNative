...
export default class AssessmentMC extends Component<Props> {
  ...
  checkAnswer = (position, correctAnswer, userAnswer) => {
    ...
    if (correctAnswer === userAnswer) {
      ...
      tracker.logEvent('assessment-listening-result-correct', {
        answer: userAnswer,
      ...
      tracker.logEvent('assessment-listening-result-incorrect', {
        answer: userAnswer,
        mode: `${modeFrom} - ${modeTo}`,
      });
    }
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ttsSpeak(question);
            tracker.logEvent('assessment-listening-read', {
              text: question.kanji,
            });
          }}
        >
        ...
        <View style={styles.selectors}>
          <CustomButton
            ...
            onPress={() => {
              this.getNext();
              tracker.logEvent('press-assessment-listening-next');
            }}
